            ...
            <div class="span12">
                <div class="widget-box">
                    <div class="widget-title"> <span class="icon"> <i class="icon-list-alt"></i> </span>
                        <h5><{if $is_new}>添加产品分类<{else}>产品分类详情<{/if}></h5>
                    </div>
                    <form action="<{'/product/saveCate.html'|getBaseUrl}>" method="post" class="form-horizontal" id="form">
                        <div class="widget-content nopadding">
                            ...
                            <div class="form-actions">
                                ...
                                <a href="<{'/product/cate'|getBaseUrl}>" class="btn" title="返回列表">返回列表</a>
                            </div>
